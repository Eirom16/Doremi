    ...
    : QWidget(parent)
{
    ...
    subtitle_ = new QLabel(QString::fromStdString(std::string(doremi_tr("welcome_subtitle"))), this);
    ...
    welcome_text_ = new QLabel(QString::fromStdString(std::string(doremi_tr("welcome_title"))), card_);
    ...
    desc_text_ = new QLabel(QString::fromStdString(std::string(doremi_tr("welcome_desc"))), card_);
    ...
    login_btn_ = new RippleButton(QString::fromStdString(std::string(doremi_tr("welcome_btn_login"))), card_, RippleButton::Variant::Primary);
...
void WelcomeView::on_login_clicked() {
    ...
    login_btn_->setText(QString::fromStdString(std::string(doremi_tr("welcome_btn_logging_in"))));
    status_label_->setText(QString::fromStdString(std::string(doremi_tr("welcome_status_opening"))));
    ...
    if (result != QDialog::Accepted) {
        ...
        login_btn_->setText(QString::fromStdString(std::string(doremi_tr("welcome_btn_login"))));
...
void WelcomeView::handle_login_success(const QString &avatar_url, const QString &user_name) {
    Q_UNUSED(avatar_url);
    Q_UNUSED(user_name);
    status_label_->setText(QString::fromStdString(std::string(doremi_tr("welcome_status_success"))));
    progress_->setText(QString::fromStdString(std::string(doremi_tr("welcome_status_loading"))));
